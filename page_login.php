    ...
    <div class="blankpage-form-field">
        ...
        <?php
            ...
            if (isset($_SESSION['success'])){
                echo "<div class=\"alert alert-success text-dark\" role=\"alert\">{$_SESSION['success']}</div>";
                unset($_SESSION['success']);
            }
            elseif (isset($_SESSION['danger'])){
                echo "<div class=\"alert alert-danger text-dark\" role=\"alert\">{$_SESSION['danger']}</div>";
